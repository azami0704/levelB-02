...
<div class="article">
    <h2 class="title">健康新知</h2>
    <div class="text">缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%
資料來源： 行政院衛生署國民健康局 
發佈日期： 2012 / 10 / 07
...
<script>
    $('.tag > div').click(function(){
        ...
        $(".article > .title").text($(this).text());
        $.get("./api/get_data.php",{table:`<?=$table?>`,id:$(this).index()+1})
        .done(res=>{
            let data=JSON.parse(res);
            $('.text').text(`${data[0].title}${data[0].text}`)
        })
